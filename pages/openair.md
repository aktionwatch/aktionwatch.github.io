...
<div style="display: flex; justify-content: space-around;">
  <div style="text-align: center;">
     <img src="{{ site.baseurl }}/assets/images/openair1.png" alt="Open Air Book Exhibition" style="width: 60%;" />
    <p style="font-size: 10px;">
      Under the Same Sky performance
    </p>
  </div>
  <div style="text-align: center;">
       <img src="{{ site.baseurl }}/assets/images/openair2.png" alt="Link 2 Image" style="width: 60%;" />
    <p style="font-size: 10px;">
      Under the Same Sky performance
    </p>
  </div>
    <div style="text-align: center;">
        <img src="{{ site.baseurl }}/assets/images/openair3.png" alt="Open Air Book Exhibition" style="width: 60%;" />
    <p style="font-size: 10px;">
